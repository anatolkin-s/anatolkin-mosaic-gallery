...
if (!str_contains($emconf, "'version' => '0.6.4'")) {
    $failures[] = 'ext_emconf.php version must be 0.6.4 for the release';
}
...
foreach ([
    'composer require anatolkin/anatolkin-mosaic-gallery:^0.6' => 'TER description must document Composer fresh install',
    ...
    'No database migration is required for 0.6.4' => 'TER description must state no database migration for 0.6.4',
] as $needle => $message) {

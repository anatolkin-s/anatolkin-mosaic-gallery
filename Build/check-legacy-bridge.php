...
if (!str_contains($emconf, "'version' => '0.6.3'")) {
    $failures[] = 'ext_emconf.php version must be 0.6.3 for the release';
}
...
foreach ([
    ...
    'No database migration is required for 0.6.3' => 'TER description must state no database migration for 0.6.3',
] as $needle => $message) {
